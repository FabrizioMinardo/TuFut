...
LOAD    DATA LOCAL INFILE '/TuFut/data_csv/CLIENTES.csv'
        INTO TABLE  CLIENTES
...
LOAD    DATA LOCAL INFILE '/TuFut/data_csv/PAGOS.csv'
        INTO TABLE  PAGOS
            FIELDS TERMINATED   BY ','  ENCLOSED BY '"'
            LINES TERMINATED    BY '\n'		 
            IGNORE 1 LINES
...
LOAD    DATA LOCAL INFILE '/TuFut/data_csv/RESERVAS.csv'
        INTO TABLE  RESERVAS 
            FIELDS TERMINATED   BY ','  ENCLOSED BY '"'
            LINES TERMINATED    BY '\n'		 
            IGNORE 1 LINES
...
LOAD    DATA LOCAL INFILE '/TuFut/data_csv/DETALLE_PAGOS.csv'
...
LOAD    DATA LOCAL INFILE '/TuFut/data_csv/RESERVAS_INSUMOS.csv'
